...
/// </summary>
internal class Compacter<TKey> : IAsyncDisposable where TKey : notnull
{
    ...
    public Compacter(LsmStorageInner<TKey> storage, TimeProvider timeProvider, StorageOptions options)
    {
        _storage = storage;
